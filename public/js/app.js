...
for (var rep in data.results) {
  ...
  var email = data.results[rep].oc_email;
  var website = data.results[rep].website;
  ...
  // Display rep email
  + '<strong>OpenCongress Email:</strong> <a href="mailto:' + email + '" target="_blank">' + email + '</a><br>'
  // Display rep website
  + '<strong>Website:</strong> <a href="' + website + '" target="_blank">' + website + '</a><br><br>'
  ...
  if (data.results[rep].facebook_id != null) {
    $('.' + data.results[rep].bioguide_id).append('<a href="https://www.facebook.com/' + data.results[rep].facebook_id + '" target="_blank"><img class="logo" src="../img/facebook_logo.png"></a>');
  }
  if (data.results[rep].twitter_id != null) {
    $('.' + data.results[rep].bioguide_id).append('<a href="https://www.twitter.com/' + data.results[rep].twitter_id + '" target="_blank"><img class="logo" src="../img/twitter_logo.png"></a>');
  }
  if (data.results[rep].youtube_id != null) {
    $('.' + data.results[rep].bioguide_id).append('<a href="https://www.youtube.com/' + data.results[rep].youtube_id + '" target="_blank"><img class="logo" src="../img/youtube_logo.png"></a>');
  }
}
